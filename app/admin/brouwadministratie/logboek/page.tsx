            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col items-center justify-center py-32 text-center">
                    <div className="bg-white border-2 border-dashed border-gray-300 p-16 max-w-lg w-full">
                        ...
                        <h1 className="text-2xl font-bold text-brewery-dark mb-3">Logboek</h1>
                        ...
                        <p className="text-gray-500 text-sm">
                            Het brouwdagboek: temperatuurmetingen, OG/FG-metingen, observaties
                            en notities per brouwbatch.
                        </p>
                    </div>
                </div>
            </div>
