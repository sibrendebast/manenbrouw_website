            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex border-b-2 border-black mb-8">
                    <button
                        ...
                        className={`px-8 py-3 font-black uppercase tracking-widest text-sm transition-colors ${
                            activeTab === "orders"
                                ? "bg-black text-white"
                    ...
                    <>
                        ...
                        <div className="mb-8">
                            ...
                            <select
                                ...
                                className="px-4 py-2 border-2 border-black focus:outline-none focus:border-brewery-green bg-white font-bold"
                            >
